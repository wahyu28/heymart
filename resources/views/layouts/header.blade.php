<header class="navbar navbar-expand-md navbar-light d-none d-lg-flex d-print-none">
    ...
    <!-- Modal Notifikasi -->
    <div class="modal modal-blur fade" id="modal-notifikasi" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                ...
                <div class="modal-body p-0">
                    ...
                    <div id="produk-notifikasi">
                        ...
                        <a href="{{ route('produk.index') }}" class="produk-list-notifikasi">
                            <p class="pt-2 pb-2 m-0" style="padding-left: 1.5rem !important"><strong>Buku Trik Dahsyat Ajax</strong> jquery tersisa <span class="text-danger"><strong>4 buah</strong></span></p>
                        </a>
                        <a href="{{ route('produk.index') }}" class="produk-list-notifikasi">
                            <p class="pt-2 pb-2 m-0" style="padding-left: 1.5rem !important"><strong>Buku Trik Dahsyat Ajax</strong> jquery tersisa <span class="text-danger"><strong>4 buah</strong></span></p>
                        </a>
